...
export const Hero = () => {
  return (
    <section className="pt-8 pb-15 md:pt-5 md:pb-10 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,#1832FF,#EAEEFE)] overflow-x-clip">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10">
          ...
          <div className="w-full md:max-w-[550px] text-center md:text-left">
            ...
            >
              ...
              <p className="text-2xl text-[#e5e6f1] tracking-tight mt-6">
                {text}
              </p>
