...
export const Hero = () => {
  return (
    <section className="pt-50 pb-30 sm:pt-30 -mt-25 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,var(--color-hero-bg-1),var(--color-hero-bg-2))] overflow-x-clip">
